 ...
 * Use for serving actions (set volume, record removal, set empty) and production complete.
 * @param {string} locationId
 * @returns {Promise<{ item: object, onHand: number }|null>} - item to use, or null if empty/conflict
 */
