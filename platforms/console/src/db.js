...
export const db = new Dexie('BrewsterConsoleDB');
...
db.version(10).stores({
  ...
  batches: 'id, name, batch_date, status, vessel_id, org_id, sync_status', // + planned_volume, planned_volume_unit
...
// v11-v12: batch_locations, batch_volume_adjustments, etc. (if not present, add)
...
// v13: milestone_templates; batch_milestones use milestone_definition_id
