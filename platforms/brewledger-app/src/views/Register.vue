<template>
  <div class="min-h-screen flex flex-col items-center justify-center p-4">
    ...
    <div class="mb-6 text-center">
      ...
      <p class="text-body-sm text-neutral-600 dark:text-neutral-400">Create organization</p>
    </div>
    ...
    <div class="w-full max-w-sm bg-white dark:bg-neutral-800 border border-neutral-200 dark:border-neutral-700 rounded-lg shadow-sm">
      ...
      <div class="p-4 border-b border-neutral-100 dark:border-neutral-700">
        <h2 class="text-body-md font-bold text-neutral-900 dark:text-neutral-50">Create Organization</h2>
      </div>
      ...
      <div class="p-4">
        <form @submit.prevent="register" class="space-y-4">
          ...
          <!-- Organization Name -->
          <div class="space-y-2">
            <label class="block text-body-sm font-medium text-neutral-700 dark:text-neutral-300">Organization Name</label>
            <input 
              v-model="orgName" 
              required 
              class="w-full px-3 py-2 border border-neutral-200 dark:border-neutral-700 rounded-md bg-white dark:bg-neutral-800 text-neutral-900 dark:text-neutral-50 placeholder-neutral-400 dark:placeholder-neutral-500 focus:ring-1 focus:ring-success-500 focus:border-success-500 outline-none"
          ...
          <!-- Admin Name -->
          <div class="space-y-2">
            <label class="block text-body-sm font-medium text-neutral-700 dark:text-neutral-300">Admin Name</label>
            <input 
              v-model="adminName" 
              required 
              class="w-full px-3 py-2 border border-neutral-200 dark:border-neutral-700 rounded-md bg-white dark:bg-neutral-800 text-neutral-900 dark:text-neutral-50 placeholder-neutral-400 dark:placeholder-neutral-500 focus:ring-1 focus:ring-success-500 focus:border-success-500 outline-none"
          ...
          <!-- Email Address -->
          <div class="space-y-2">
            <label class="block text-body-sm font-medium text-neutral-700 dark:text-neutral-300">Admin Email</label>
            <input 
              v-model="email" 
              type="email" 
              required 
          ...
          <div class="space-y-2">
            <div class="flex justify-between items-center">
              ...
              <span v-if="password" class="text-body-xs px-1.5 py-0.5 rounded" :class="isPasswordValid ? 'bg-success-100 dark:bg-success-900/30 text-success-700 dark:text-success-400' : 'bg-warning-100 dark:bg-warning-900/30 text-warning-700 dark:text-warning-400'">
                {{ passwordStrength }}
              </span>
            </div>
            <input 
          ...
          <!-- Confirm Password -->
          <div class="space-y-2">
            <label class="block text-body-sm font-medium text-neutral-700 dark:text-neutral-300">Confirm Password</label>
            <input 
              ...
              placeholder="••••••••" 
            />
            <div v-if="passwordMismatch" class="text-danger-600 dark:text-danger-400 text-body-sm">
          ...
          <button 
            ...
            class="w-full bg-success-600 hover:bg-success-700 text-white py-2.5 rounded-md font-bold text-body-sm disabled:opacity-50 disabled:cursor-not-allowed"
          >
        ...
        <div class="mt-4 pt-4 border-t border-neutral-100 dark:border-neutral-700 text-center">
          <p class="text-body-sm text-neutral-600 dark:text-neutral-400 mb-2">Already have an organization?</p>
